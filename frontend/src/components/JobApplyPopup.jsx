...
const JobApplyPopup = ({ showApplyBox, setshowApplyBox, companyId, JobId }) => {
     ...
     const handleSendApplication = async () => {
          ...
          if (resume !== null) {
               ...
               const response = await axios.post("http://localhost:3001/api/users/send-job-application",
                    data,
                    {
                         headers: {
     ...
     return (
          ...
          <div className={`absolute z-10 top-12 left-1/2 -translate-x-1/2  w-[600px] overflow-auto rounded duration-500 ${showApplyBox ? "translate-y-0 opacity-100" : "-translate-y-[100px] opacity-0"} `}>
