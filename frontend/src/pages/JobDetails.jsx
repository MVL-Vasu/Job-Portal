     ...
     return JobData ? (
          ...
          <div className='mx-auto min-h-screen dark:bg-dark-primary flex flex-col pb-10 2xl:px-20 '>
               ...
               <div data-aos="fade-up" data-aos-once="true" data-aos-duration="1000" className='relative mb-14 '>
                    <div className="overflow-hidden absolute left-0 right-0 -bottom-[1px] text-[#F4F7FB] dark:text-dark-primary">
               ...
               <div className='flex flex-col dark:text-white lg:flex-row justify-between px-20 items-start'>
                    ...
                    <div data-aos="" data-aos-offset="30" data-aos-once="true" data-aos-duration="1000" className='lg:sticky top-20 w-full lg:w-2/3 py-10 px-12 bg-white dark:bg-dark-box-bg shadow-[var(--box-shadow-custom)] rounded-lg '>
                    ...
                    <div className='lg:sticky top-20 w-full lg:w-1/3 mt-8 lg:mt-0 lg:ml-8 space-y-5'>
                         ...
                         {/* JOB OVERVIEW */}
                         <div data-aos="fade-up" data-aos-once="true" data-aos-duration="1000" className='bg-white dark:bg-dark-box-bg p-8 pt-5 shadow-[var(--box-shadow-custom)] rounded-lg'>
                         ...
                         {/* EMBEDED GOOGLE MAP */}
                         <div data-aos="fade-up" data-aos-offset="30" data-aos-once="true" data-aos-duration="1000" className='bg-white dark:bg-dark-box-bg p-6 pt-5 shadow-[var(--box-shadow-custom)] rounded-lg'>
